 ...
 */
final class Version20221007075834 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE eleves_questionnaires (eleves_id INT NOT NULL, questionnaires_id INT NOT NULL, INDEX IDX_E601ED04C2140342 (eleves_id), INDEX IDX_E601ED04CABD5540 (questionnaires_id), PRIMARY KEY(eleves_id, questionnaires_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
